...
<script src="{{ asset('frontend/js/style-customizer/js/spectrum.js') }}"></script>
<script src="{{ asset('frontend/js/less/less.min.js') }}" data-env="development"></script>
<script src="{{ asset('frontend/js/style-customizer/js/style-customizer.js') }}"></script>
<!-- Scripts END -->
...
<script type="text/javascript" src="{{ asset('frontend/js/cubeportfolio/main-mosaic-flat.js') }}"></script>
...
<!-- REVOLUTION JS FILES -->
<script type="text/javascript" src="{{ asset('frontend/js/revolution-slider/js/jquery.themepunch.tools.min.js') }}">
</script>
<script type="text/javascript"
    src="{{ asset('frontend/js/revolution-slider/js/jquery.themepunch.revolution.min.js') }}"></script>
