    ...
    <div class="container-fluid">
        <div class="card mt-4">
            <div class="card-body">
                ...
                @endif
                <form class="form-horizontal p-t-20" action="{{ route('service.store') }}" method="POST"
                        ...
                        <tbody>
                            @foreach ($services as $key => $item)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>
                                        <img src="{{ asset('uploads/service/' . $item->image) }}" width="100px"
                                            alt="">
                                    </td>
                                    <td>
                                        @if (session()->get('language') == 'bangla')
                                    ...
                                    <td><a href="{{ route('service.edit', $item->id) }}" title="Edit"
