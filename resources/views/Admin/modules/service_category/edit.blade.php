    ...
    <div class="container-fluid">
        <div class="card mt-4">
            <div class="card-body">
                ...
                <form class="form-horizontal p-t-20" action="{{ route('service-category.update', $service_category->id) }}"
                            ...
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="uname1" name="service_category"
                                        ...
                                        value="{{ $service_category->service_category ?? null }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-sm-12">
                                ...
                                <img id="image-preview"
                                    src="{{ asset('uploads/service_category/' . $service_category->image) }}" class="mt-2"
