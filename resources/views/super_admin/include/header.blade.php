    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header text-center" style="padding:0px">
            <a style="width: 220px" class="navbar-brand"
                @if (auth()->user()->role == 'admin') href="{{ url('/') }}" @elseif (auth()->user()->role == 'employee') href="{{ url('employee/home') }}" @else href="{{ url('/home') }}" @endif>
                <!-- Logo icon --><b>
                    ...
                    <!-- Light Logo icon -->
                    <img src="{{ asset($logo->logo_image ?? null) }}" alt="homepage" width="150px" class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text --></a>
        </div>
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <div class="app-search d-none d-md-block d-lg-block">
                        <h6 class="pt-4 mx-5"><strong>Balance: {{ $balance }} Taka</strong></h6>
                    </div>
                </li>
            </ul>
            <!-- ============================================================== -->
                    ...
                    <ul class="dropdown-menu dropdown-menu-end animated flipInY">
                        @if (session()->get('language') == 'bangla')
                            <li><a href="{{ route('english.language') }}"
                                    style="font-size:16px;color: black;margin-left:20px"><i class="ti-user"></i>
                                    English</a>
                            </li>
                        @else
                            <li><a href="{{ route('bangla.language') }}"
                                    style="font-size:16px;color: black;margin-left:20px"><i class="ti-user"></i>
                                    বাংলা</a>
                            </li>
                        @endif
