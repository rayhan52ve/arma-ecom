                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-material mx-2"
                            action="{{ route('serviceProvider.profile_update', Auth::user()->id) }}" method="POST"
                            ...
                            <div class="mb-4">
                                <label class="image" for="imageInput">
                                    ...
                                    @endphp
                                    @if (@$image)
                                        <img id="profileImage" src="{{ asset('uploads/user/' . $image) }}" height="150"
                                            width="150">
                                    @else
                                        <img id="profileImage" src="{{ asset('assets/avatar.png') }}" height="150"
                                            width="150">
                                    @endif
