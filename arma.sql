...
--
-- Host: localhost:3306
-- Generation Time: Mar 14, 2024 at 07:45 AM
...
CREATE TABLE `added_times` (
  ...
  `added_service_time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `added_charge_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(7, '1709096557.jpg', 'Your Personal Assistant', 'Two-stop solution for your services. Order any service, anytime.', '2024-02-27 05:59:56', '2024-03-11 09:27:24');
...
INSERT INTO `careers` (`id`, `cv`, `name`, `email`, `phone`, `skill`, `message`, `created_at`, `updated_at`) VALUES
(1, '1710135881.pdf', 'Sajid', 'customer@gmail.com', '67576576774', 'dfgdfg', 'fdgfg', '2024-03-11 05:44:41', '2024-03-11 05:44:41'),
(3, '1710138248.pdf', 'Sajid Rayhan', 'sajidadmin@admin.com', '0111111111111', 'Laravel', NULL, '2024-03-11 06:24:08', '2024-03-11 06:24:08');
...
CREATE TABLE `emails` (
  ...
  `copy` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `expenses` (
  ...
  `expense_amount_bangla` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comment` text COLLATE utf8mb4_unicode_ci,
  `comment_bangla` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `expense_types` (
  ...
  `expense_type_bangla` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(78, '2024_03_11_112512_create_careers_table', 33),
(80, '2024_03_12_093632_create_service_sub_categories_table', 34);
...
CREATE TABLE `payrolls` (
  ...
  `order_id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `payroll` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(13, 21, NULL, 37, 'ijhgihbljhbliu', NULL, '2024-03-11 10:42:07', '2024-03-11 10:42:07');
...
CREATE TABLE `services` (
  ...
  `service_sub_category_id` int UNSIGNED DEFAULT NULL,
...
(5, '1710222745.jpg', 'Ac Repair Service', '2024-01-21 11:41:41', '2024-03-12 05:52:25'),
(6, '1710222849.jpg', 'Appliance Repair', '2024-01-21 11:41:45', '2024-03-12 05:54:09'),
(8, '1710222903.png', 'Pest Control', '2024-01-21 11:42:09', '2024-03-12 05:55:03'),
(12, '1710301974.png', 'For Your Home', '2024-03-13 03:52:54', '2024-03-13 03:52:54'),
(14, '1710314819.jpg', 'Extra', '2024-03-13 07:24:51', '2024-03-13 07:26:59'),
(15, '1710314843.jpg', 'test', '2024-03-13 07:25:02', '2024-03-13 07:27:23'),
(16, '1710314727.png', 'test 2', '2024-03-13 07:25:27', '2024-03-13 07:25:27');
...
INSERT INTO `service_sub_categories` (`id`, `image`, `name`, `service_category_id`, `description`, `created_at`, `updated_at`) VALUES
(3, '1710219235.jpg', 'test', 5, '<p>ryrty</p>', '2024-03-12 04:53:44', '2024-03-12 04:53:55');
...
CREATE TABLE `users` (
  ...
  `employee_type` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `website_infos` (
  ...
  `marquee` mediumtext COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `website_infos` (`id`, `address`, `phone`, `telephone`, `email`, `description`, `marquee`, `facebook`, `tweeter`, `google`, `linkedin`, `instagram`, `copy_right`, `created_at`, `updated_at`) VALUES
(1, '3096 Cemetery Hollow Street, Houston, TX 77099', '0111111111111', '(888) 123-4567', 'email@example.com', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit consectetuer adipiscing elit. Suspendisse et justo. augue.', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo augue. Aliquam ornare hendrerit consectetuer adipiscing elit. Suspendisse et justo. augue.', 'https://www.facebook.com/', NULL, NULL, NULL, NULL, 'Copyright © 2019 Arma By Codelayers | All rights reserved.', '2024-01-28 09:14:55', '2024-03-11 10:21:55');
